...
export default function EncadreurDetailPage({
  ...
  const accesBloque = estParent && profil && !profil.acces_paye;
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="relative mt-4">
        <div className={`${accesBloque ? "blur-md pointer-events-none select-none" : ""} bg-white border border-gray-200 rounded-xl overflow-hidden transition-all`}>
      ...
      {accesBloque && (
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/60 rounded-xl z-10">
          <div className="text-center px-6">
            ...
            <h3 className="text-lg font-semibold text-zinc-800 mb-1">Accès restreint</h3>
            <p className="text-sm text-zinc-500 mb-4">Payez pour accéder aux coordonnées et contacter cet encadreur.</p>
            <Link
              href={`/paiement/${profil.id}`}
